...
import com.javahacks.demo.model.BaseElement;
...
public class ModelPackageImpl extends EPackageImpl implements ModelPackage {
	 ...
	 * @see com.javahacks.demo.model.ModelPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public void initializePackageContents() {
		...
		containerEClass.getESuperTypes().add(this.getItem());
		itemEClass.getESuperTypes().add(this.getBaseElement());

		// Initialize classes, features, and operations; add parameters
		initEClass(containerEClass, com.javahacks.demo.model.Container.class, "Container", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getContainer_Items(), this.getItem(), null, "items", null, 0, -1, com.javahacks.demo.model.Container.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
